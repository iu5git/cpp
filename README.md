...
**особенно важно соблюдать ограничения:**

- не использовать string;
- не использовать auto;
- не использовать `магические числа` — числовые значения оформлять как `const` в анонимном пространстве имён;
- `char*` и массивы символов в этой лабораторной работе не нужны;
