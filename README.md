# 4 - сортировка одномерного числового массива <!-- omit in toc -->
...
- Трижды отсортировать массив двумя методами (элементы массива, подаваемых функциям сортировки, должны быть одинаковы). После каждой сортировки вывести значения отсортированного массива, количество перестановок и сравнений (для каждого метода):
  1. - Отсортировать исходный (неотсортированный) массив по возрастанию;
	2. - Отсортировать получившийся массив по возрастанию (заново);
	3. - Отсортировать получившийся массив по убыванию.
...
*Элементы массивов не надо выводить на экран.*
